...
(function () {
    ...
    const option3 = {
        ...
        legend: {
            data: ['E-mail', 'Anúncios em rede', 'Anúncios em vídeo', 'Direto', 'Buscador'],
            textStyle: {
              color: '#777'
            }
        },
        ...
        series: [
            ...
            {
                name: 'Anúncios em rede',
                type: 'line',
                stack: 'Total',
                data: [220, 182, 191, 234, 290, 330, 310]
            },
            {
                name: 'Anúncios em vídeo',
                type: 'line',
                stack: 'Total',
    ...
    const option5 = {
        ...
        legend: {
            data: ['Degrau no início', 'Degrau no meio', 'Degrau no fim'],
            textStyle: {
              color: '#777'
            }
        },
    ...
    const option9 = {
        ...
        xAxis: {
            ...
            data: ['Total', 'Aluguel', 'Contas', 'Transporte', 'Refeições', 'Outros'],
            axisLine: {
                lineStyle: {
                    color: "#8c9097"
                }
    ...
    const option11 = {
        ...
        legend: {
            data: ['Floresta', 'Estepe', 'Deserto', 'Pântano'],
            textStyle: {
              color: '#777'
            }
        },
    ...
    const option12 = {
        ...
        yAxis: {
            type: 'category',
            data: ['Brasil', 'Indonésia', 'EUA', 'Índia', 'China', 'Mundo'],
            axisLine: {
                lineStyle: {
                    color: "#8c9097"
                }
        ...
        series: [
            {
                ...
                data: [
                    ...
                    { value: 484, name: 'Anúncios em rede' },
    ...
    const data = [
        [
            [28604, 77, 17096869, 'Austrália', 1990],
            [31163, 77.4, 27662440, 'Canadá', 1990],
            [1516, 68, 1154605773, 'China', 1990],
            [13670, 74.7, 10582082, 'Cuba', 1990],
            [28599, 75, 4986705, 'Finlândia', 1990],
            [29476, 77.1, 56943299, 'França', 1990],
            [31476, 75.4, 78958237, 'Alemanha', 1990],
            [28666, 78.1, 254830, 'Islândia', 1990],
            [1777, 57.7, 870601776, 'Índia', 1990],
            [29550, 79.1, 122249285, 'Japão', 1990],
            [2076, 67.9, 20194354, 'Coreia do Norte', 1990],
            [12087, 72, 42972254, 'Coreia do Sul', 1990],
            [24021, 75.4, 3397534, 'Nova Zelândia', 1990],
            [43296, 76.8, 4240375, 'Noruega', 1990],
            [10088, 70.8, 38195258, 'Polônia', 1990],
            [19349, 69.6, 147568552, 'Rússia', 1990],
            [10670, 67.3, 53994605, 'Turquia', 1990],
            [26424, 75.7, 57110117, 'Reino Unido', 1990],
            [37062, 75.4, 252847810, 'Estados Unidos', 1990]
        ],
        [
            [44056, 81.8, 23968973, 'Austrália', 2015],
            [43294, 81.7, 35939927, 'Canadá', 2015],
            [13334, 76.9, 1376048943, 'China', 2015],
            [21291, 78.5, 11389562, 'Cuba', 2015],
            [38923, 80.8, 5503457, 'Finlândia', 2015],
            [37599, 81.9, 64395345, 'França', 2015],
            [44053, 81.1, 80688545, 'Alemanha', 2015],
            [42182, 82.8, 329425, 'Islândia', 2015],
            [5903, 66.8, 1311050527, 'Índia', 2015],
            [36162, 83.5, 126573481, 'Japão', 2015],
            [1390, 71.4, 25155317, 'Coreia do Norte', 2015],
            [34644, 80.7, 50293439, 'Coreia do Sul', 2015],
            [34186, 80.6, 4528526, 'Nova Zelândia', 2015],
            [64304, 81.6, 5210967, 'Noruega', 2015],
            [24787, 77.3, 38611794, 'Polônia', 2015],
            [23038, 73.13, 143456918, 'Rússia', 2015],
            [19360, 76.5, 78665830, 'Turquia', 2015],
            [38225, 81.4, 64715810, 'Reino Unido', 2015],
            [53354, 79.1, 321773631, 'Estados Unidos', 2015]
        ]
    ];
    const option17 = {
    ...
    const option19 = {
        legend: {
            data: ['Orçamento alocado', 'Gasto real'],
            left: '0%',
            top: '0%',
            textStyle: {
              color: '#777'
        ...
        radar: {
            indicator: [
                { name: 'Vendas', max: 6500 },
                { name: 'Administração', max: 16000 },
                { name: 'Tecnologia da informação', max: 30000 },
                { name: 'Suporte ao cliente', max: 38000 },
                { name: 'Desenvolvimento', max: 52000 },
                { name: 'Marketing', max: 25000 }
            ]
        },
        series: [
            {
                name: 'Orçamento vs gasto',
                type: 'radar',
                data: [
                    {
    ...
    const option22 = {
        ...
        legend: {
            data: ['Exibição', 'Clique', 'Visita', 'Consulta', 'Pedido'],
            textStyle: {
              color: '#777'
            }
        },
        series: [
            {
                ...
                data: [
                    ...
                    { value: 20, name: 'Pedido' },
                    { value: 80, name: 'Clique' },
                    { value: 100, name: 'Exibição' }
                ]
            }
        ],
        color: ['#985ffd', '#ff49cd', '#fdaf22', '#32d484', '#00c9ff', '#ff6757', 'rgba(53, 181, 170,1)']
