(function () {
    ...
    const multipleoptions = {
        ...
        title: {
            text: 'XYZ - Análise de ações (2009 - 2016)',
            align: 'left',
            offsetX: 110,
            style: {
                fontSize: '13px',
        ...
        yaxis: [
            ...
            },
            {
                ...
                title: {
                    text: "Fluxo de caixa operacional (milhares)",
                    style: {
                        color: '#ff49cd',
                    }
                },
    ...
    const lineoptions = {
        ...
        labels: ['Dez 01', 'Dez 02', 'Dez 03', 'Dez 04', 'Dez 05', 'Dez 06', 'Dez 07', 'Dez 08', 'Dez 09 ', 'Dez 10', 'Dez 11'],
        markers: {
            size: 0
        },
        xaxis: {
