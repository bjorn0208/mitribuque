(function () {
    ...
    const stackedoptions = {
        ...
        title: {
            text: 'Vendas de livros de ficção',
            style: {
                fontSize: '13px',
                fontWeight: 'bold',
                color: '#8c9097'
    ...
    const negativeoptions = {
        ...
        title: {
            text: 'Pirâmide populacional de Maurício 2011',
            align: 'left',
            style: {
                fontSize: '13px',
                fontWeight: 'bold',
    ...
    const reversedbaroptions = {
        ...
        xaxis: {
            categories: ['Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro', 'Novembro', 'Dezembro'],
            labels: {
                show: true,
                style: {
                    colors: "#8c9097",
    ...
    const categoriesoptions = {
        ...
        subtitle: {
            text: 'Nomes das categorias dentro das barras',
            align: 'center',
        },
        tooltip: {
            theme: 'dark',
    ...
    const patternedoptions = {
        ...
        title: {
            text: 'Comparar estratégias de vendas',
            style: {
                fontSize: '13px',
                fontWeight: 'bold',
                color: '#8c9097'
    ...
    const imagefilloptions = {
        ...
        title: {
            text: 'Barras preenchidas com imagem',
            align: 'right',
            offsetY: 30,
            style: {
                fontSize: '13px',
