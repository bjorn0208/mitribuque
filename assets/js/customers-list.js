    ...
    const grid = new gridjs.Grid({
        columns: [
            ...
            },
            {
                name: 'Status',
                formatter: (_, row) => gridjs.html(
                    `<span class="badge bg-${row.cells[3].data === 'Active' ? 'success' : 'danger'}-transparent">${({ 'Active': 'Ativo', 'Blocked': 'Bloqueado' })[row.cells[3].data] || row.cells[3].data}</span>`
                )
            },
            'Data de cadastro',
            {
                ...
                formatter: (_, row) => gridjs.html(`
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="javascript:void(0);"><i class="ri-pencil-line me-2"></i>Editar</a></li>
