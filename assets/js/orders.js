(function () {
    ...
    // Sample Data
    const ordersData = [
        ['#SPK001', 'John Doe', '../assets/images/faces/9.jpg', '$699.99', 'Pending', 'Pending', 'Cartão Visa', 'Jan 15, 2025, 09:45 AM', 'john.doe@example.com'],
        ...
        ['#SPK005', 'Chris Johnson', '../assets/images/faces/11.jpg', '$199.99', 'Shipped', 'Cancelled', 'Na entrega', 'May 1, 2025, 10:30 AM', 'chris.johnson@example.com'],
        ...
        ['#SPK009', 'James Wilson', '../assets/images/faces/14.jpg', '$59.99', 'Cancelled', 'Completed', 'Cartão Visa', 'Sep 5, 2025, 06:00 PM', 'james.wilson@example.com'],
        ['#SPK010', 'Sophia Martinez', '../assets/images/faces/5.jpg', '$39.99', 'Shipped', 'Failed', 'Na entrega', 'Oct 12, 2025, 08:15 AM', 'sophia.martinez@example.com']
    ];
    ...
    const grid = new gridjs.Grid({
        columns: [
            ...
            'Preço',
            {
                ...
                formatter: (_, row) => gridjs.html(
                    `<span class="badge bg-${row.cells[4].data === 'Pending' ? 'warning' : row.cells[4].data === 'Shipped' ? 'info' : row.cells[4].data === 'Delivered' ? 'success' : 'danger'}-transparent">${({ 'Pending': 'Pendente', 'Shipped': 'Enviado', 'Delivered': 'Entregue', 'Cancelled': 'Cancelado', 'Completed': 'Concluído', 'Failed': 'Falhou', 'Refunded': 'Reembolsado' })[row.cells[4].data] || row.cells[4].data}</span>`
                )
            },
            {
            ...
            },
            {
                ...
                formatter: (_, row) => gridjs.html(
                    `<span class="text-${row.cells[5].data === 'Pending' ? 'info' : row.cells[5].data === 'Completed' ? 'success' : row.cells[5].data === 'Failed' ? 'orange' : row.cells[5].data === 'Refunded' ? 'warning' : 'danger'}"><i class="ri-circle-fill me-1 fs-10"></i>${({ 'Pending': 'Pendente', 'Shipped': 'Enviado', 'Delivered': 'Entregue', 'Cancelled': 'Cancelado', 'Completed': 'Concluído', 'Failed': 'Falhou', 'Refunded': 'Reembolsado' })[row.cells[5].data] || row.cells[5].data}</span>`
                )
            },
            'Data do pedido',
            {
                ...
                formatter: (_, row) => gridjs.html(`
                    <div class="dropdown text-center">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="orders-details.html"><i class="ri-eye-line me-2"></i>Ver</a></li>
