(function () {
    ...
    const markers = [
        ...
        { name: 'França', coords: [46.6034, 1.8883] },
        { name: 'EUA', coords: [37.0902, -95.7129] }
    ]
    ...
    const Categoriesoptions = {
        ...
        labels: ['Eletrônicos', 'Moda', 'Móveis', 'Eletrodomésticos', 'Games'],
        dataLabels: {
            enabled: false,
        },
        plotOptions: {
    ...
    const Ordersoptions = {
        ...
        labels: ["Entregues", "Cancelados", "Pendentes", "Devolvidos"],
        chart: {
            height: 258,
            type: 'donut',
        },
