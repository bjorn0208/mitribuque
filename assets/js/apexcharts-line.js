(function () {
    ...
    const basicoptions = {
        ...
        title: {
            text: 'Tendência de produtos por mês',
            align: 'left',
            style: {
                fontSize: '13px',
                fontWeight: 'bold',
    ...
    const dataoptions = {
        ...
        title: {
            text: 'Temperatura média máx. e mín.',
            align: 'left',
            style: {
                fontSize: '13px',
                fontWeight: 'bold',
    ...
    const zoomableoptions = {
        ...
        title: {
            text: 'Movimento do preço da ação',
            align: 'left',
            style: {
                fontSize: '13px',
                fontWeight: 'bold',
    ...
    const missingoptions = {
        ...
        title: {
            text: 'Dados ausentes (valores nulos)',
            align: 'left',
            style: {
                fontSize: '13px',
                fontWeight: 'bold',
    ...
    Apex = {
        chart: {
            ...(window.ApexPtBr ? { locales: [window.ApexPtBr], defaultLocale: 'pt-br' } : {}),
            height: 160,
        },
        dataLabels: {
            enabled: false
    ...
    const realoptions = {
        ...
        title: {
            text: 'Gráfico com atualização dinâmica',
            align: 'left',
            style: {
                fontSize: '13px',
                fontWeight: 'bold',
