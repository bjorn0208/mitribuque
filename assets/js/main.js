...
/* Localização pt-BR das bibliotecas (Choices.js e ApexCharts) */
(function () {
  "use strict";
  if (window.Choices && Choices.defaults && Choices.defaults.options) {
    Object.assign(Choices.defaults.options, {
      loadingText: "Carregando...",
      noResultsText: "Nenhum resultado encontrado",
      noChoicesText: "Nenhuma opção disponível",
      itemSelectText: "Clique para selecionar",
      uniqueItemText: "Apenas valores únicos podem ser adicionados",
      customAddItemText: "Apenas valores que atendem às condições podem ser adicionados",
      addItemText: function (value) {
        return 'Pressione Enter para adicionar <b>"' + String(value).replace(/[&<>"']/g, "") + '"</b>';
      },
  ...
  window.Apex.chart = Object.assign({}, window.Apex.chart || {}, {
    locales: [window.ApexPtBr],
    defaultLocale: "pt-br"
  });
})();
