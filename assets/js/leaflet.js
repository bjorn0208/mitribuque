(function () {
    ...
    marker1.bindPopup("<b>Olá, mundo!</b><br>Eu sou um popup.").openPopup();
    circle1.bindPopup("Eu sou um círculo.");
    polygon1.bindPopup("Eu sou um polígono.");
    const popup = L.popup()
        .setLatLng([51.513, -0.09])
        .setContent("Eu sou um popup independente.")
        .openOn(popupmap);
